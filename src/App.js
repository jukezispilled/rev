  ...
  return (
    ...
    >
      <div className='-mt-[45%] md:-mt-[20%] relative'>
        {!isReviving && <img src="rev.png" alt="Rev" />}
        {isReviving && (
      ...
      >
        <div className="font-custom flex flex-col sm:flex-row justify-center bg-green-600 z-10 items-center gap-1 md:gap-3 px-5 py-3 max-w-full border-2 border-yellow-400">
          <button
