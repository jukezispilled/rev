  ...
  return (
    ...
    >
      ...
      <div className='absolute top-3 right-3 md:flex space-x-1 items-center z-[50] hidden'>
        <a href="https://x.com/revivesolana" className='transition ease-in-out duration-150'>
        ...
        <a href="https://t.me/REVIVEportalsol" className='transition ease-in-out duration-150'>
